    ...
    <main className="android-page" id="top">
      ...
      <section className="android-delivery" id="android-foundation" data-reveal>
        <div className="container">
          <SectionHeading eyebrow="Our Android foundation" title="Building natively from the beginning." copy="Our product, design, and engineering work is focused on creating a dependable first version that is ready to validate, refine, and launch." />
          <div className="android-delivery-grid">
            <article><span>01</span><h3>Native foundation</h3><p>Kotlin and Jetpack Compose give our product a responsive interface, reliable performance, and a maintainable foundation.</p></article>
            <article><span>02</span><h3>Thoughtful experience</h3><p>Clear flows, accessible interfaces, and early prototypes help us shape an intuitive experience before launch.</p></article>
            <article><span>03</span><h3>Launch readiness</h3><p>Automated testing, performance checks, security reviews, and release planning prepare the product for Google Play.</p></article>
          </div>
        </div>
      </section>
    </main>
