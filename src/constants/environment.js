...
export const ENVIRONMENT = Object.freeze({
  ...
  office: Object.freeze({
    ...
    timezone: readEnvironmentValue('VITE_OFFICE_TIMEZONE', 'India Standard Time · UTC+5:30'),
    mapEmbedUrl: readEnvironmentValue('VITE_MAP_EMBED_URL', ''),
    directionsUrl: readEnvironmentValue('VITE_MAP_DIRECTIONS_URL', 'https://www.openstreetmap.org'),
  }),
